...
This is the official code of the paper: Boosting Audio-visual Zero-shot Learning with Large Language Models. Unfortunately, we are unable to make the pre-trained models and original code public at this time due to AntGroup's licensing restrictions. However, we plan to release them in the near future. We provide descriptions generated using GPT for everyone to use. You can easily reproduce our method using [AVCA](https://github.com/ExplainableML/AVCA-GZSL).
![](Doc/KDA.jpg)
